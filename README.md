...
- Recommended Build Tools: https://react.dev/learn/build-a-react-app-from-scratch
...
- Vite: Use [Vite](https://vite.dev/guide/) to create a react app. Create React App is deprected.
